...
const ModifierCompteParent = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.modifierCompteParent}>
      <View style={styles.modifierCompteParentChild} />
      <Image
      ...
      <Image
        style={styles.modifierCompteParentItem}
        contentFit="cover"
      ...
      <View style={styles.modifierCompteParentInner} />
...
export default ModifierCompteParent;
