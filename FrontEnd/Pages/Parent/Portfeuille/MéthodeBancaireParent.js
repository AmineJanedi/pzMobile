  ...
  const navigation = useNavigation();
    ...
    return (
      ...
      <View style={styles.mthodeBancaire20}>
        ...
        <Text style={[styles.text1, styles.textTypo]}>1563 5201 6969 4850</Text>
        ...
        />
           <TextInput
            style={{top:455,left:60,color:'white'}} // Style de TextInput
        ...
        />
         <TextInput
            style={{top:510,left:60,color:'white'}} // Style de TextInput
        ...
        />
        <TextInput
            style={{top:558,left:60,color:'white'}} // Style de TextInput
        ...
        <View
          style={[styles.mthodeBancaire20Child4, styles.mthodeChildShadowBox]}/>
           <TextInput
            style={{top:540,left:220,color:'white'}} // Style de TextInput
            placeholder="XXX"
            inputMode="numeric"
            maxLength={3}
            onChangeText={(text) => {
        ...
        />
          <TextInput
            style={{top:588,left:65,color:'white'}} // Style de TextInput
      ...
      position: "absolute",}}>Montant</Text>
        ...
        {/*Boutton payer */}
         ...
         <Pressable
          ...
          onPress={() => navigation.navigate("MéthodeCoupons")}>
...
export default MthodeBancaire2;
