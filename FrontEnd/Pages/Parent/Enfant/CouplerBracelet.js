...
const CouplerBracelet = () => {
  return (
    <View style={styles.associerUneNouvelleBracelet}>
      ...
      <View
        style={[
          styles.associerUneNouvelleBraceletChild,
          styles.amineWrapperLayout,
        ]}
      />
      ...
      <Image
        ...
        source={require("../../../assets/icon.png")}
      />
      <Text style={[styles.associer, styles.budgetTypo]}>Associer</Text>
      <View
        style={[
...
export default CouplerBracelet;
